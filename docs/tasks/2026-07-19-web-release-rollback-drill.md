...
- [ ] Cập nhật canonical docs, commit/push và xác minh CI.
...
Đang chờ review/commit/push và CI. Production đã quay lại exact current image;
rollback snapshot/evidence được giữ ngoài repository. Không đổi client hoặc data
contract.
