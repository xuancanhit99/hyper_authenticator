...
| `flutter test` | Pass 206 test ngày 09-08-2026 |
...
| Full gate | `scripts/agent/check.sh full` pass ngày 09-08-2026: docs/codegen/format/analyze/platform, 206 Flutter test, migration/release/infra harness |
...
| GitHub Preview 1.1.2 | Public pre-release [`v1.1.2-preview.1`](https://github.com/xuancanhit99/hyper_authenticator/releases/tag/v1.1.2-preview.1) từ commit `4f7781c7d97e4ccf79f59c30c4c62ea88ff240dd`; exact tag CI run [`31316900626`](https://github.com/xuancanhit99/hyper_authenticator/actions/runs/31316900626) pass 8/8 ngày 09-08-2026; public verifier [`31317354030`](https://github.com/xuancanhit99/hyper_authenticator/actions/runs/31317354030) xác nhận đúng 9 asset, digest/checksum/manifest, Android signer pin, Debian, Windows PE32 và Chrome Extension package |
