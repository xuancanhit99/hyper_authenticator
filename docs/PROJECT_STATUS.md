...
| `flutter test` | Pass 227 test ngày 10-08-2026 |
...
| Full gate | `scripts/agent/check.sh full` pass ngày 10-08-2026: docs/codegen/format/analyze/platform, 227 Flutter test, migration/release/infra harness |
...
| GitHub Preview 1.1.2 | Public pre-release [`v1.1.2-preview.2`](https://github.com/xuancanhit99/hyper_authenticator/releases/tag/v1.1.2-preview.2) từ commit `35772c4dae0bf222d7530342d16b7a4e39a6976f`; exact tag CI run [`31368043015`](https://github.com/xuancanhit99/hyper_authenticator/actions/runs/31368043015) pass 8/8 ngày 10-08-2026; public verifier độc lập [`31368861723`](https://github.com/xuancanhit99/hyper_authenticator/actions/runs/31368861723) xác nhận đúng 9 asset, digest/checksum/manifest, Android signer pin, Debian, Windows PE32 và Chrome Extension package |
