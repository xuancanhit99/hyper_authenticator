...
| GitHub Preview 8 | Public pre-release [`v1.1.0-preview.8`](https://github.com/xuancanhit99/hyper_authenticator/releases/tag/v1.1.0-preview.8) từ commit `ed0cd0167c232003126d25b3ac112c4d85aaa96f`; exact tag CI run `31284467915` pass ngày 09-08-2026; public verifier xác nhận đúng 7 asset, digest/checksum/manifest, Android signer pin, Debian và Windows PE32 |
