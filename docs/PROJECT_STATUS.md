...
| GitHub Preview 1.1.1 | Public pre-release [`v1.1.1-preview.1`](https://github.com/xuancanhit99/hyper_authenticator/releases/tag/v1.1.1-preview.1) từ commit `b3b4c0c2314aa3088995319adc4af1faf5dbb313`; exact tag CI run `31314025618` pass ngày 09-08-2026; public verifier xác nhận đúng 9 asset, digest/checksum/manifest, Android signer pin, Debian, Windows PE32 và Chrome Extension package |
