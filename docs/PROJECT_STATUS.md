...
- Root privacy shield fail closed che TOTP/recovery/user content khi lifecycle không
  còn `resumed`, không dispose hoặc mutate state/vault bên dưới.
...
- `scripts/agent/check.sh full` là quality gate canonical; baseline hiện có 128 test,
