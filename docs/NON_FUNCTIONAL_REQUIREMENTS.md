...
Evidence 19-07-2026: bounded soak 900 request/1.134 giây đạt 100% HTTP 200 và
p95 292 ms nhưng một tail spike 3.648 ms làm strict max gate fail. Baseline
100 request chạy ngay sau pass p95 402/max 406 ms. Vì proxy log chưa có duration,
không coi baseline pass là bằng chứng phủ định spike; cần thêm correlation timing.
