...
| A-037 | Vendor Sentinel provider icon catalog đã pin, local-only, tự suy ra từ issuer và fallback avatar ký tự | Chấp nhận | [ADR-0023](adr/0023-vendor-sentinel-provider-icons.md) |
